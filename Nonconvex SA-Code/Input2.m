...
awr = menu(mtitle, [N_description ,num2str(N_iter)] ,['Regularization parameter(lambda): ', num2str(lambda)] , ['Evaluation sample size (K): ', num2str(N_vali)] , ['Number of runs: ', num2str(Run_times)] , ['Run:', cur_alg], 'Change the algorithm');
if awr == 1
